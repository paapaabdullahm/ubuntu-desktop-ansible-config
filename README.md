...
_git_ | Git is a version control system for tracking changes in computer files and coordinating work on those files among multiple people. | you should modify the default git global config variables found in `git/defaults/main.yml`
